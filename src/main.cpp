...
const string strMessageMagic = "HashDollar Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime)
{
    int64 nRewardCoinYear;
        ...
        // HashDollar: reward for coin-year is cut in half every 64x multiply of PoS difficulty
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HashDollar
    bool fStrictPayToScriptHash = true; // Always active in HashDollar
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HashDollar", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Tuesday, January 14 2014: Cade aprova sem restrições fusão entre Portugal Telecom e Oi";
        CTransaction txNew;
		...
		txNew.strTxComment = "text:HashDollar genesis block";
        ...
        assert(block.hashMerkleRoot == uint256("0x9c721988600af2d44223f097105462d54de63a2fda8b6cbea1be9f5cecba2ac6"));
